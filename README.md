...
```javascript
itermmeanabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-mmeanabs@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-mmeanabs@v0.2.2-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-mmeanabs/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-iter-mmeanabs/actions/workflows/test.yml?query=branch:v0.2.2
